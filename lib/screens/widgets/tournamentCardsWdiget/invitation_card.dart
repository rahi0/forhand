...
class InvitationCard extends StatelessWidget {
  final event;
  InvitationCard(this.event);
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
       // Navigator.of(context).pushNamed("/eventDetails/${event.id}");
        Navigator.push(context, SlideLeftRoute(page: EventDetails("${event.id}")));
      },
          child: Container(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image:  NetworkImage(
                      CallApi().baseUrl+'${event.eventImg}'),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  alignment: Alignment.center,
                                  child: Text(
                                    '${event.singedupCount} ${FlutterI18n.translate(context, "Signed up")}',
                                    textDirection: TextDirection.ltr,
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 17.0,
                                ...
                                Container(
                                  ...
                                  alignment: Alignment.center,
                                  child: Text(
                                    '${event.eventLimit - event.singedupCount} ${FlutterI18n.translate(context, "Left")}',
                                    textDirection: TextDirection.ltr,
                                    style: TextStyle(
                          ...
                          child: Text(
                            '${event.eventFee}${FlutterI18n.translate(context, "kr")}',
                            textDirection: TextDirection.ltr,
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 19.0,
